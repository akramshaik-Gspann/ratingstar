    ...
    return (
        <div className='filterone'>
            ...
            <div className='attribute'>
                ...
                <label><input type="checkbox" onChange={(e) => filterHandler(e.target.checked, "/jewelery")} checked={pathname == "/jewellery"} id="option" name="option" value="option" />&nbsp;Jewelery</label>
